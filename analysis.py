...
if __name__ == '__main__':
	...
	# print_util(yaml_details, Y_prediction_data, ['ECBS1_2'])
	# print_util(yaml_details, Y_prediction_data, ['EECBS1_2'])
	print_util(yaml_details, Y_prediction_data, ['PBS'])
	# print_util(yaml_details, Y_prediction_data, ['ECBS1_1'])
	# print_util(yaml_details, Y_prediction_data, ['EECBS1_1'])
	...
	# print('EECBS1_2:', calculate_time(yaml_details, inv_mapping, list(Y_prediction_data.keys()), [mapping['EECBS1_2']]*len(Y_prediction_data)))
	print('PBS:', calculate_time(yaml_details, inv_mapping, list(Y_prediction_data.keys()), [mapping['PBS']]*len(Y_prediction_data)))
	# print('ECBS1_1:', calculate_time(yaml_details, inv_mapping, list(Y_prediction_data.keys()), [mapping['ECBS1_1']]*len(Y_prediction_data)))
	# print('EECBS1_1:', calculate_time(yaml_details, inv_mapping, list(Y_prediction_data.keys()), [mapping['EECBS1_1']]*len(Y_prediction_data)))
