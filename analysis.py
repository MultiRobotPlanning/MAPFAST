...
if __name__ == '__main__':
	...
	print_util(yaml_details, Y_prediction_data, ['ECBS'])
	print_util(yaml_details, Y_prediction_data, ['EECBS'])
	...
	print('\nTotal Runtime:')
	print('ECBS:', calculate_time(yaml_details, inv_mapping, list(Y_prediction_data.keys()), [mapping['ECBS']]*len(Y_prediction_data)))
	print('EECBS:', calculate_time(yaml_details, inv_mapping, list(Y_prediction_data.keys()), [mapping['EECBS']]*len(Y_prediction_data)))
